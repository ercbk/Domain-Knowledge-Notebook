...
-   relative tree canopy change - change of tree canopy over a period of time
		-   e.g (for 1 hexagon) relative tree canopy change % = (tree\_canopy\_area\_2019 - tree\_canopy\_area\_2012) / tree\_canopy\_area\_2012
		-   Acre gain per <category>
...
-   Data sources
		...
		-   Resources:
				-   [Paper](http://Paper summarizing our tree canopy mapping approach) summarizing their tree canapy mapping approach
...
-   % <metric> using 500-acre hexagons  
    ![](./_resources/Environment.resources/Screenshot-(744).png)
-   Use LiDAR Hill shade map with % canopy change to highlight local areas  
    ![](./_resources/Environment.resources/Screenshot-(746).png)
-   Land Use Categories
		-   Overall: residential, commercial, and recreational
		-   Metric change by category | acres lost (orange)/gained (green) by category  
		    ![](./_resources/Environment.resources/Screenshot-(750).png)  
		    ![](./_resources/Environment.resources/Screenshot-(748).png)
		-   Change per Council District (by metric)  
		    ![](./_resources/Environment.resources/Screenshot-(754).png)  
		    ![](./_resources/Environment.resources/Screenshot-(753).png)
