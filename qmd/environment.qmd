...
- NDVI saturates above roughly 0.8, so you're averaging a compressive transform of biomass rather than biomass itself. EVI, kNDVI, or LAI are less compressed if canopy density is the actual construct. Snow and persistent cloud make winter values meaningless at higher latitudes, and those months are still being averaged in as real numbers, so a growing-season restriction is often more defensible than a calendar-year window.
