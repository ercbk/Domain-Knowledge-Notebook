...
-   Also see
    -   [Algorithms, Product \>\> Cost-Benefit Analysis](https://ercbk.github.io/Data-Science-Notebook/qmd/algorithms-product.html#sec-alg-prod-cba){style="color: green"}
    -   [Optimization \>\> Budget Allocation](https://ercbk.github.io/Data-Science-Notebook/qmd/optimization-equation-systems.html#sec-opt-ba){style="color: green"}
    -   [Project, Planning \>\> Decision Models](https://ercbk.github.io/Data-Science-Notebook/qmd/project-planning.html#sec-proj-plan-decmod){style="color: green"}
