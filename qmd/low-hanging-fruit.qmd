...
-   See [Job, Organizational and Team Development](Job, Organizational and Team Development)
...
-   See [Algorithms, Marketing](Algorithms, Marketing) >> Churn
...
-   See
		-   [Job, Organizational and Team Development](Job, Organizational and Team Development) >> Developing a data strategy >> OKRs
		-   [KPIs](KPIs)
...
-   See [Demand Planning](Demand Planning) >> Demand Forecasting
-   https://www.remixinstitute.com/blog/automated-demand-forecasts-using-autocatboostcarma-in-r/#.XX_q6ShKi1s (some good pitch material)
...
-   See [Marketing](Marketing) >> Workflow >> Find the Ideal Customer Profile (ICP) and target them
