...
- Using R for projects
  ...
  - [Posit](https://posit.co/), who maintains RStudio and Positron IDEs (integrated development environment) and many of the most popular R packages, have many full time staff working solely on maintaining and creating new functionality within R. This means we get:
...
- See [Logistics, Demand Planning \>\> Intermittent Demand](logistics-demand-planning.qmd#sec-log-demfcast-intdem){style="color: green"}
