...
Conversion Funnels ![](./_resources/Product_Development.resources/image.4.png)
...
-   **Funnel Metrics** are any family of metrics that tracks the "user journey" through various parts of a product.
    ...
    -   Conversion funnels: a standard "conversion path" through the product, captured through basic metrics such as:
        ...
        -   What makes a good step to monitor in a conversion funnel? Notes from [Step Suggestions: How We Take the "Guess and Check" Out of Building Funnels](https://heap.io/blog/step-suggestions-how-we-automate-building-funnels)
            -   A good funnel step is ubiquitous: almost no users reach the next step without performing this action.![](./_resources/Product_Development.resources/funnel-results-when-x-is-ubiquitous.png)
                -   Examples:
            ...
            -   A good funnel step is divisive: some users drop off before performing the step, and others drop off after.![](./_resources/Product_Development.resources/funnel-results-x-is-divisive.png)
...
-   **Growth Metrics** (AARRR) - are responsible for enlarging a product's user base and keeping current users engaged
            ...
            -   If daily use is NOT where the company's value comes from, then find and investigate **power users**.
                ...
                -   Power User Curve (aka activity histogram or the "L30")
                    ...
                    -   "Smile" curves are good
                        -   Monthly![](./_resources/Product_Development.resources/image.1.png)
                        ...
                        -   Weekly![](./_resources/Product_Development.resources/image.2.png)
                    ...
                    -   Cohort analysis![](./_resources/Product_Development.resources/image.3.png)
    ...
    -   RARRA instead of AARRR?![](./_resources/Product_Development.resources/1aihm6-T1GIPS5VDZxjq7Xw.png)
