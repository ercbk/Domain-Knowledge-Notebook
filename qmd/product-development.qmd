...
-   Distribution of effect sizes for webpage variations using Optimizely (platform for A/B testing) data\
    ![](./_resources/Product_Development.resources/FICx2hFXEAUYbOz.png){width="432"}
...
-   Loyalty measure by app category\
    ![](./_resources/Product_Development.resources/image.png){width="432"}
...
-   [Master Data Models]{.underline}: Creating a final/clean view of your customers and associated facts and dimensions.
    -   Start with a "Customer → Transaction → Event" framework (more [details](https://www.flywheelsoftware.com/help-center-articles/preparing-your-data-for-flywheel))![](./_resources/Product_Development.resources/1-MVPyykz1OOXltfCWZL62ig.png){width="432"}
...
![](./_resources/Product_Development.resources/image.4.png){width="432"}
...
-   [Data]{.underline}
    -   Funnel data at the user-level over a time period\
        ![](./_resources/Product_Development.resources/image.5.png){width="532"}
...
-   [Conversion Funnels]{.underline}: a standard "conversion path" through the product, captured through basic metrics such as:
    ...
    -   [What makes a good step to monitor in a conversion funnel?]{.underline}
        ...
        -   A good funnel step is ubiquitous: almost no users reach the next step without performing this action.\
            ![](./_resources/Product_Development.resources/funnel-results-when-x-is-ubiquitous.png){width="432"}
            -   Examples:
        ...
        -   A good funnel step is divisive: some users drop off before performing the step, and others drop off after.\
            ![](./_resources/Product_Development.resources/funnel-results-x-is-divisive.png){width="432"}
...
-   [Power User Curve]{.underline} (aka [Activity Histogram]{.underline} or the "[L30]{.underline}")
    ...
    -   ["Smile" Curves are Good]{.underline}
        -   Monthly\
            ![](./_resources/Product_Development.resources/image.1.png){width="632"}
        ...
        -   Weekly\
            ![](./_resources/Product_Development.resources/image.2.png){width="632"}
    ...
    -   [Cohort Analysis]{.underline}\
        ![](./_resources/Product_Development.resources/image.3.png){width="632"}
...
![](./_resources/Product_Development.resources/1aihm6-T1GIPS5VDZxjq7Xw.png){width="532"}
