# Product Development  {#sec-proddev}

## Misc  {#sec-proddev-misc}

-   Also see [Decison Theory](Decison%20Theory) \>\> Conjoint Analysis for surveying consumers about product attributes to calculate attribute utilities and probability of purchase
-   Flaws of Purchase-Funnel Based Attribution Metrics
    ...
    -   Solution involves causal mediation analysis (also see [Causal Inference](Causal%20Inference) \>\> Mediation Analysis)
-   Distribution of effect sizes for webpage variations using Optimizely (platform for A/B testing) data![](./_resources/Product_Development.resources/FICx2hFXEAUYbOz.png)
...
-   Loyalty measure by app category![](./_resources/Product_Development.resources/image.png)
...
-   [**Product Details Page**]{style="color: #009499"} **(PDP)**\]{style='color: #009499'} - webpage for a specific product that shows in-depth information

## Behavioral Data  {#sec-proddev-behdat}
...
-   Misc
    ...
    -   Also see [Marketing](Marketing) \>\> Customer Segmentation \>\> Behaviorial Segmentation
-   Sources
...
-   Process Data
    ...
    -   Master Data Models: Creating a final/clean view of your customers and associated facts and dimensions.
        -   Start with a "Customer → Transaction → Event" framework (more [details](https://www.flywheelsoftware.com/help-center-articles/preparing-your-data-for-flywheel))![](./_resources/Product_Development.resources/1-MVPyykz1OOXltfCWZL62ig.png)
...
## Conversion Funnels  {#sec-proddev-convfun} ![](./_resources/Product_Development.resources/image.4.png)
...
-   Misc
    -   Also see
        ...
        -   [Algorithms, Product](Algorithms,%20Product) \>\> Customer Journey, Conversion Funnel
...
-   Data
    -   Funnel data at the user-level over a time period![](./_resources/Product_Development.resources/image.5.png)
...
## Stages of Product Development  {#sec-proddev-sopd}
...
## Why do people leave and stay?  {#sec-proddev-wdplas}
...
-   Types
    ...
    -   Growth
    -   Platform
-   **Success metrics** (sometimes called a "north star metric" or "primary metric" or "OKR metric") are used to measure the success or health of a product. Commonly used (daily/monthly) success metrics include:
    -   active users
    -   bookings / purchases
    -   revenue
    -   click through rate conversion rate
-   **Guardrail metrics** measures core quantities that should not degrade in pursuit of a new product or feature. Success metrics of other core product teams can sometimes also serve as guardrail metrics. Examples can include:
    ...
    -   latency
-   **Funnel Metrics** are any family of metrics that tracks the "user journey" through various parts of a product.
    ...
    -   Conversion funnels: a standard "conversion path" through the product, captured through basic metrics such as:
        ...
        -   What makes a good step to monitor in a conversion funnel? Notes from [Step Suggestions: How We Take the "Guess and Check" Out of Building Funnels](https://heap.io/blog/step-suggestions-how-we-automate-building-funnels)
            -   A good funnel step is ubiquitous: almost no users reach the next step without performing this action.  
                ![](./_resources/Product_Development.resources/funnel-results-when-x-is-ubiquitous.png)
                -   Examples:
            ...
            -   A good funnel step is divisive: some users drop off before performing the step, and others drop off after.  
                ![](./_resources/Product_Development.resources/funnel-results-x-is-divisive.png)
...
-   **Input-output Metrics**
    ...
    -   [Example]{.ribbon-highlight}: Fraud Detection
        ...
        -   Input metrics
            -   true / false positive rates of
                ...
                -   operations manual review volumes
                    -   A human is reviews the case to determine whether action is needed. In fraud, an model output may trigger a "manual review" to determine whether an event was indeed fraudulent.
        ...
        -   Output metrics
            ...
            -   losses prevented
            -   revenue
-   **Growth Metrics** (AARRR) - are responsible for enlarging a product's user base and keeping current users engaged
    -   AARRR
                ...
                -   Power User Curve (aka activity histogram or the "L30")
                    -   Histogram of users' engagement by the total number of days they performed which action you've deemed valuable in a month
                        ...
                        -   I don't think this concept has to be limited to time being on the x-axis. It could be any metric value you consider representative of a "power user."
                            -   Also see [Google, Analytics, Analysis](Google,%20Analytics,%20Analysis) \>\> Power User Analysis
                                -   Y axis: % users, X axis: visits
                    -   Time period depends on your products natural cycle. May be monthly ("L30"), weekly ("L7"), daily, etc.
                    ...
                    -   "Smile" curves are good
                        -   Monthly  
                            ![](./_resources/Product_Development.resources/image.1.png)
                        ...
                        -   Weekly  
                            ![](./_resources/Product_Development.resources/image.2.png)
                    ...
                    -   Cohort analysis  
                        ![](./_resources/Product_Development.resources/image.3.png)
    ...
    -   RARRA instead of AARRR?  
        ![](./_resources/Product_Development.resources/1aihm6-T1GIPS5VDZxjq7Xw.png)
