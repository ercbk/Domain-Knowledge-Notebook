...
-   Packages
    ...
    -   [{]{style="color: #990000"}[lightweightchartR](https://arkraieski.github.io/lightweightchartR/){style="color: #990000"}[}]{style="color: #990000"} - Visualization package designed for {quantmod} users.
        -   Makes interactive market charts feel natural in R
        -   Keeps the workflow pipe-friendly
        -   Supports common trading-chart patterns like volume overlays, moving averages, and indicator panes without a lot of setup
...
-   Packages
    ...
    -   [{]{style="color: #990000"}[edgarfundamentals](https://cran.r-project.org/web/packages/edgarfundamentals/index.html){style="color: #990000"}[}]{style="color: #990000"} - Retrieve Fundamental Financial Data from SEC 'EDGAR'
        -   Includes earnings per share, return on equity, return on assets, debt-to-equity, current ratio, gross margin, operating margin, net margin, price-to-earnings, price-to-book, and dividend yield for any publicly traded U.S. company
