...
-   Packages
    ...
    -   [{]{style="color: #990000"}[inflationkit](https://cran.r-project.org/web/packages/inflationkit/index.html){style="color: #990000"}[}]{style="color: #990000"} - Inflation Decomposition, Core Measures, and Trend Estimation
    ...
    -   [{]{style="color: #990000"}[nowcastr](https://whocov.github.io/nowcastr){style="color: #990000"}[}]{style="color: #990000"} - Implements the chain-ladder method for nowcasting, supporting both non-cumulative delay-based estimation and model-based completeness fitting (*e.g.*, logistic or Gompertz curves)
...
-   [**Nowcasting**]{style="color: #009499"} - The process of estimating the current state of a phenomenon when the data are incomplete due to reporting delays.
