...
-   [**Spread**]{style="color: #009499"} ([**Bid-Ask**)]{style="color: #009499"}: the difference between two prices, rates or yields. - the gap between the bid and the ask prices of a security or asset, like a stock, bond or commodity. - the gap between a short position (that is, selling) in one futures contract or currency and a long position (that is, buying) in another. This is officially known as a spread trade
...
-   Copulas
    -   See [Correlation, Association, and Distance \>\> Copulas](https://ercbk.github.io/Data-Science-Notebook/qmd/correlation-association-and-distance.html#sec-corrassdist-cop){style="color: green"}
