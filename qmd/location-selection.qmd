...
-   Might be more useful to aggregate smaller geographies into overlapping circular areas to compare candidates\
    ![](./_resources/Location_Selection.resources/1-iT14nGkyxpTDKrzXieHUpg.png){width="632"}
...
-   [Example]{.ribbon-highlight}: Workforce and Demographic ![](./_resources/Location_Selection.resources/1-u7KtEJ5Gbi-zaDd5dwRlhQ.png){width="632"}\
    ![](./_resources/Location_Selection.resources/1-KAR-xT1uxjSvNfxvpPBdiQ.png){width="632"}
