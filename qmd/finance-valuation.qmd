...
-   Project FCF
    ...
    -   Steps
        -   Get historical data for Sales, COGS, Gross Margin, SG&A, EBITDA, D&A, and EBIT for the last 3 to 5 years. Get a consensus of projected estimates for Sales, EBITDA, and EBIT.\
        ...
        -   For each variable, calculate the average percentage (last column)
        -   For variables, multiply each variable's average percentage times each projected Sales estimate to get each variable projected estimate for each period of the horizon.\
            ![](_resources/Finance.resources/dcf-varproj-fillin-1.png){width="532"}
            -   For projecting COGS and SG&A, it's typical to hold Gross Margin and SG&A (as a percentage of Sales) constant. Although, you may want to make a slight adjustment due to company trends or the outlook of the market.
        -   For EBIT and EBITDA, something
