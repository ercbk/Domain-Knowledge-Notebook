...
-   Misc
    ...
    -   Disadvantages
        ...
        -   Terminal Value: Can represent 3/4 or more of the valuation, and this value depends on the final period of the forecast horizon which is the most uncertain.
...
-   [Determining the Terminal Value]{.underline}
    ...
    -   A **Terminal Value** is used to capture the remaining value of the FCF beyond the projection period - 2/3 of the overall valuation depends on this terminal value.
    ...
    -   Exit Multiple Method (EMM)
        ...
        -   Determines the remaining FCF by means of a multiple. This multiple is typically based on the Last-Twelve-Month (LTM) trading multiples of comparable companies.
    ...
    -   Gordon Growth Method aka Perpetuity Growth Method (PGM)\
        ...
        -   The perpetuity growth rate is typically chosen on teh basis of the company's expected lont-term industry growth rate which generally tends to be around the nominal GDP growth (2% - 4%)
...
-   [Determine the Valuation]{.underline}
    ...
    -   Calculate the Present Value (PV) of FCF~i~: $\text{FCF}_i \times \text{Discount Factor}_i$
...
-   [Perform Sensitivity Analysis]{.underline}
    ...
    -   [Example]{.ribbon-highlight}: Trying Different WACC and Exit Multiple Values\
        ...
        -   Relatively minor effects result from changes in WACC and the Exit Multiple.
