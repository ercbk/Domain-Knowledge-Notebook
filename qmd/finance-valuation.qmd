...
-    A **Terminal Value** is used to capture the remaining value of the target beyond the projection period
    -   2/3 of the overall valuation depends on this terminal value.
    -   Determined by the **Exit Multiple** or the **Gordon Growth** method
...
-   Project FCF
    ...
    -   For public companies, estimates of sales, EBITDA, and EBIT for the first 2 or 3 years can obtained from reports generated by other analysts who specialize in the sector. The consensus or average of these estimates can be used to produce forecasts.
    ...
    -   COGS (gross margin) and SG&A (as a percentage of sales) estimates are obtained from historical data for the early projection period. For the later years, it's typical to hold gross margin and SG&A as a percentage of sales constant. Although, you may want to make a slight adjustment due to company trends or the outlook of the market.
