...
-   **CPM** or Cost Per Thousand Impressions is the amount _advertisers_ are willing to pay for every one thousand impressions they receive
		-   CPM = (campaign\_budget \* 1000) / #\_of\_desired\_impressions
-   **eCPM** or effective CPM is the predicted revenue earned by a _publisher_ for every one thousand impressions; metric for ad testing
		-   eCPM = (estimated\_earnings \* 1000) / total\_impressions
...
-   **RPM** is similar to eCPM; it's the amount earned by _publishers_ per thousand pageviews
...
-   Also see
		-   Data Science >> [Algorithms, Marketing](Algorithms, Marketing)
		-   Data Science >> [Business Plots](Business Plots)
...
-   **Cost per Incremental Conversion (CPiP)**
		...
		-   If the CPiP < Customer Lifetime Value (CTV)(see [Algorithms, Business](Algorithms, Product)) and this margin is acceptable at which to acquire customers, then the treatment (e.g. ad campaign) can move to production
...
-   Steps
	...
	4. Analysis
		...
		-   Example DiD![](./_resources/Marketing.resources/0-7mG9DH1XOy4T3g9G.png)
...
-   Misc
		...
		-   The concave shape of diminishing returns![](./_resources/Marketing.resources/1-Zus4VojzJJbIIFZ2rPqYJw.png)
		...
		-   Carryover Effect
				...
				-   Adstock is a decaying function that describes the average carryover effect![](./_resources/Marketing.resources/1-Fmr_wpbh0SV7EHwZthBA4g.png)
				...
				-   Calculate a "spend\_with\_adstock" variable![](./_resources/Marketing.resources/1-PzWaS2vmwbiVg60-B8_6uQ.png)
...
-   Marketing mix modeling (MMM)
		-   Sales (or ) ~ Channel\_Spend (+ Trend + Seasonality(s) + Campaigns + Events + Holidays + Weather +... etc.)
...
-   Mobile Channel Attribution
		...
		-   Apple's [SKAdNetwork](https://developer.apple.com/documentation/storekit/skadnetwork)![](./_resources/Marketing.resources/https-3A-2F-2Fspecials-images.jpg%3Ffit%3Dscale]]
...
-   Optimize bidding for value vs traffic volume characteristics of key words
		...
		-   What should the outcome variable be? (binary: conversion/no\_conversion or numeric: bid value)
...
-   Also see
		...
		-   [Algorithms, Product](Algorithms, Product) >> Customer Journey
-   Seeks to answer:
...
-   RFM Analysis (Recency, Frequency, and Monetary Value)![](./_resources/Marketing.resources/image.2.png)
		-   Just need a transactional database with client’s orders over time (at least 2.5 to 3 yrs of data to capture enough behavior variation).![](./_resources/Marketing.resources/image.3.png)
		-   time frame could be monthly or yearly or any other time frame required by the business
		-   Explicitly creates sub-groups based on how much each customer is contributing.![](./_resources/Marketing.resources/image.4.png)
		...
		-   Modelling
		-   Also see
				-   [Algorithms, Marketing](Algorithms, Marketing) >> Customer Lifetime Value >> BG/NBD Gamma-Gamma model
				-   Video: Bizsci
		...
		-   Example![](./_resources/Marketing.resources/image.6.png)![](./_resources/Marketing.resources/image.5.png)
				-   Charts
...
-   Behavioral Segmentation
		...
		-   Also see
				-   Customer Journey
				-   [Product Development](Product Development) >> Behavioral Data
		-   Data
		...
		-   Example: Telecommunications![](./_resources/Marketing.resources/image.7.png)
...
Customer Journey
![](./_resources/Marketing.resources/image.1.png)![](./_resources/Marketing.resources/image.png)
...
-   Misc
		-   Also see [Algorithms, Product](Algorithms, Product) >> Customer Journey
-   Pre Sale
...
-   Find the Ideal Customer Profile (ICP) and target them ([article](https://towardsdatascience.com/a-complete-guide-to-data-driven-customer-acquisition-f0f1708b328))![](./_resources/Marketing.resources/image.8.png)
		...
		-   Use experimentation on High-Value cohorts to test which acquisition/marketing campaigns have high ROAS.![](./_resources/Marketing.resources/image.9.png)
...
-   Potential Pitfalls
		...
		-   Example: Churn
				-   Also see [Algorithms, Marketing](Algorithms, Marketing) >> Churn
		...
		-   Example: Increasing user spend for a video game
				...
				-   Guessing there's a decent correlation between weekly total\_time\_spent\_playing and overall revenue and they thought they could increase revenue by increasing total time\_spent\_playing. They should have been looking at correlations between features and spend\_per\_customer.
