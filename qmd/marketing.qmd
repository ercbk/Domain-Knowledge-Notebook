...
-   Packages
    -   [{]{style="color: #990000"}[ti](https://cran.r-project.org/web/packages/ti/index.html){style="color: #990000"}[}]{style="color: #990000"} - Time Intelligence and Customer Segmentation for Financial Analysis
        -   Functions for period-over-period comparisons (year-over-year, month-over-month) and period-to-date calculations (YTD, MTD, QTD)
        -   Included customer segmentation (ABC analysis, cohorts)
