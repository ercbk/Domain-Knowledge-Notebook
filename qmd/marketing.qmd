...
## Geo-experiments {#sec-mark-geoexp}
...
-   Steps
    ...
    4.  Analysis
        ...
        -   Example DiD\
            ![](./_resources/Marketing.resources/0-7mG9DH1XOy4T3g9G.png)

## Channel Attribution {#sec-mark-chanatt}
...
-   Misc
    ...
    -   Model should reflect these characteristics
        -   The concave shape of diminishing returns\
            ![](./_resources/Marketing.resources/1-Zus4VojzJJbIIFZ2rPqYJw.png)
        ...
        -   Carryover Effect
            ...
            -   Adstock is a decaying function that describes the average carryover effect\
                ![](./_resources/Marketing.resources/1-Fmr_wpbh0SV7EHwZthBA4g.png)
...
## Search Engine Marketing (SEM) {#sec-mark-sem}
...
## Customer Segmentation {#sec-mark-custseg}
...
## Customer Journey {#sec-mark-custjourn}
