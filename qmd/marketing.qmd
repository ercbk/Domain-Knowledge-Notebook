...
-   [Bid Elasticity]{.underline}
    ...
    -   Basic Formula for Bid Elasticity of Supply\
        $$
        \mbox{Price Elasticity of Bids} = \frac{\text{% Change in Metric}}{\text{% Change in Bids}}
        $$
    ...
    -   Non-Normalized metrics are misleading
        ...
        -   Clicks (metric) vs Bid Price vs Days Active\
            ...
            -   Since the the bid price of €0.40 was active more days than the €0.70 bid price, it had more click opportunities which leads to more clicks
