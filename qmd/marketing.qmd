...
-   [**CPM**]{style="color: #009499"} or Cost Per Thousand Impressions is the amount *advertisers* are willing to pay for every one thousand impressions they receive
...
-   [**GRP**]{style="color: #009499"} -  Gross Rating Point. A standard measure in advertising, it measures advertising impact. You calculate it as a
...
-   [**Identifier for Advertisers (IDFA)**]{style="color: #009499"} - a random device identifier assigned by Apple to a user's device. Advertisers use them to precisely target and track users within apps on iOS devices \[**Impression**: An instance of each time your ad is shown on a search result page or other site on the Google Network. (i.e. number of people your ad reaches)
...
-   [**Inventory**]{style="color: #009499"} is the amount of ad space (or the number of advertisements) that a publisher has available to sell. While the term originated from print, it has grown to encompass ad space on the web and on apps and mobile ads
...
-   [**RPM**]{style="color: #009499"} is similar to eCPM; it's the amount earned by *publishers* per thousand pageviews
...
-   Also see
    -   Data Science \>\> [Algorithms, Marketing](Algorithms,%20Marketing)
    -   Data Science \>\> [Business Plots](Business%20Plots)
...
-   **Cost per Incremental Conversion (CPiP)**
    ...
    -   If the CPiP \< Customer Lifetime Value (CTV)(see [Algorithms, Business](Algorithms,%20Product)) and this margin is acceptable at which to acquire customers, then the treatment (e.g. ad campaign) can move to production
    ...
    -   Model should reflect these characteristics
        ...
        -   Carryover Effect
            ...
            -   Adstock is a decaying function that describes the average carryover effect![](./_resources/Marketing.resources/1-Fmr_wpbh0SV7EHwZthBA4g.png)
                ...
                -   Calculate a "spend_with_adstock" variable![](./_resources/Marketing.resources/1-PzWaS2vmwbiVg60-B8_6uQ.png)
...
-   Also see
    ...
    -   [Algorithms, Product](Algorithms,%20Product) \>\> Customer Journey
-   Seeks to answer:
...
-   RFM Analysis (Recency, Frequency, and Monetary Value)![](./_resources/Marketing.resources/image.2.png)
    ...
    -   Modelling
        -   Also see
            -   [Algorithms, Marketing](Algorithms,%20Marketing) \>\> Customer Lifetime Value \>\> BG/NBD Gamma-Gamma model
            -   Video: Bizsci
...
-   Behavioral Segmentation
    ...
    -   Misc
        -   Also see
            -   Customer Journey
            -   [Product Development](Product%20Development) \>\> Behavioral Data
    -   Data
        ...
        -   [Example]{.ribbon-highlight}: Telecommunications![](./_resources/Marketing.resources/image.7.png)
...
Customer Journey ![](./_resources/Marketing.resources/image.1.png)![](./_resources/Marketing.resources/image.png)
...
-   Misc
    -   Also see [Algorithms, Product](Algorithms,%20Product) \>\> Customer Journey
-   Pre Sale
...
-   Potential Pitfalls
    -   Make sure the metric fits the business question.
        -   [Example]{.ribbon-highlight}: Churn
            -   Also see [Algorithms, Marketing](Algorithms,%20Marketing) \>\> Churn
