...
-   Also see
		-   [Algorithms, Marketing](Algorithms, Marketing) >> Propensity Model and Uplift Score Model
...
-   Map User Journey
		...
		-   Example: B2B![](./_resources/Retail.resources/image.png)
-   Questions
		...
		-   Which customer cohorts are likely to schedule sales calls with us and how do they behave _without_ sales guidance
...
-   Steps
		-   Use the customers that purchased at the store in the past 12 or 24 months _(you need to be the judge on timeframe based on your business model)_, and map them to where they live, e.g., at census block group level.
