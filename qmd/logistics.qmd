...
-   [**Linked Lines**]{style="color: #009499"} (aka \[**Silent Switches**) - refer to when several products in a retailer's inventory are commercially equivalent. In other words, when identical products are identified by multiple SKUs.
...
## Demand Forecasting  {#sec-log-demfcast}
...
-   Notes from [Are Your Demand Forecasts Hurting Profits and Service Levels](https://towardsdatascience.com/are-your-demand-forecasts-hurting-profits-and-service-levels-f61af7c5ff)
    ...
    Notes from [Case Study: Applying a Data Science Process Model to a Real-World Scenario](https://towardsdatascience.com/case-study-applying-a-data-science-process-model-to-a-real-world-scenario-93ae57b682bf) A VERY detailed article that goes through a scenario of step-by-step planning and execution of changing a manual stock replenishment process to an automated one
...
## Safety Stock (aka Buffer Stock)  {#sec-log-safstk}
...
-   **(Cycle) Service level (Z)** - the probability that the amount of inventory on hand during the lead time is sufficient to meet expected demand -- that is, the probability that a stockout will not occur.
    ...
    -   [Example]{.ribbon-highlight}: ![](./_resources/Logistics.resources/Screenshot-(493).png)
    ...
    -   When the demand interval doesn't equal lead time interval
        ...
        -   **Safety stock = Z × √\[PC / T1\] × σD**
            ...
            -   σD = standard deviation of demand.
                -   (Partial) [Example]{.ribbon-highlight}: if the standard deviation of demand is calculated from weekly demand data and the total lead time including review period is three weeks.
                    -   PC = 21 days (3 weeks)
...
## Economic Order Quantity (EOQ) (aka Wilson Formula)  {#sec-log-eoq}
