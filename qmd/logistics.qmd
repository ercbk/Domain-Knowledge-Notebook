...
-   Goal: develop a replenishment policy that will minimize your ordering, holding and shortage costs.
    -   [OUT level policy](logistics.qmd#sec-log-outpol){style="color: green"} is widely recommended as a replenishment policy
    -   Costs (Also see [EOQ](logistics.qmd#sec-log-eoq){style="color: green"}, [DIM \>\> DI Components](logistics.qmd#sec-log-dim-dicmp){style="color: green"})
...
-   Also see
    ...
    -   [DoorDash \>\> Forecast Supply and Demand](logistics.qmd#sec-log-drdsh)
...
-   Metrics
    ...
    -   See [Decision Impact Metrics](logistics.qmd#sec-log-dim){style="color: green"}
...
-   Protection Interval is your horizon, which equals the length of the review period + length of the lead time
    -   See [Order-Up-To (OUT) Level Policy](logistics.qmd#sec-log-outpol){style="color: green"} for details
...
-   Also see [Decision Impact Metrics](logistics.qmd#sec-log-dim){style="color: green"}
...
### Misc {#sec-log-safstk-misc .unnumbered}
...
### Reasons for Safety Stock {#sec-log-safstk-rfss .unnumbered}
...
### Stockouts {#sec-log-safstk-stkots .unnumbered}
...
### (Cycle) Service level (Z) {#sec-log-safstk-cslz .unnumbered}
...
### Safety Stock Equations {#sec-log-safstk-sseqs .unnumbered}
...
### Issues {#sec-log-safstk-iss .unnumbered}
...
## Order-Up-To (OUT) Level Policy {#sec-log-outpol .unnumbered}
...
## Reorder Point {#sec-log-reordpt .unnumbered}
...
## Decision Impact Metrics {#sec-log-dim .unnumbered}

### Misc {#sec-log-dim-misc .unnumbered}

-   Also see [Demand Forecasting \>\> Intermittent Demand \>\> Diagnostics](logistics.qmd#sec-log-demfcast-intdem-diag){style="color: green"} \>\> Accuracy Implication Metrics
...
### Forecast Accuracy Metrics Are Flawed {#sec-log-dim-famaf .unnumbered}
...
### DI Components {#sec-log-dim-dicmp .unnumbered}
...
### Steps {#sec-log-dim-steps .unnumbered}
...
## Profit Functions for Perishable Products {#sec-log-pffpp .unnumbered}
...
## Case Study: DoorDash {#sec-log-drdsh .unnumbered}
...
-   [Flow Distribution of units between production areas and markets]{.underline}\
    ![](./_resources/Logistics.resources/image.png){width="482"}
    -   Data 
...
-   [Network Optimization]{.underline}\
    ![](./_resources/Logistics.resources/image.1.png){width="632"}
...
## Warehouse Management {#sec-log-warmang .unnumbered}
...
-   [Material Flow Types]{.underline}
    -   **Simple Flows**: To understand how these movements work, we can examine the simplest possible flow, which takes place when units sent by the supplier are used, without dividing these up.\
        ![](./_resources/Logistics.resources/image.4.png){width="432"}
    -   **Medium flows**: Movements start to become more complex with this type of flow. It is normally found in warehouses with single or combined picking operations, generally with the supply of full pallets.\
        ![](./_resources/Logistics.resources/image.5.png){width="432"}
    -   **Complex Flows**: There are warehouses with different working areas, depending on the types of product and their consumption. They normally have intermediate handling areas and can require various operations that in turn need flows of a certain (and at times great) complexity. This diagram shows an example of this type of facility and the loading movements that occur there.\
        ![](./_resources/Logistics.resources/image.6.png){width="432"}
-   [Warehouse Optimization]{.underline}\
    ![](./_resources/Logistics.resources/image.2.png){width="432"}\
    ![](./_resources/Logistics.resources/image.3.png){width="432"}
