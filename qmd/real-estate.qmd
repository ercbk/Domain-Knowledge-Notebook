...
## Business Questions {#sec-rlest-bizq}
...
## Appraisal Methods (Price Estimation) {#sec-rlest-apprais}

### Traditional {#sec-rlest-apprais-trad}
...
### ML Approaches {#sec-rlest-apprais-ml}

#### Misc {#sec-rlest-apprais-ml-misc}
...
#### Features {#sec-rlest-apprais-ml-feats}
...
-   Adding nontraditional data sources can improve estimates\
    ![](./_resources/Real_Estate.resources/nontraditional-data.png)

#### Hedonic Pricing Method {#sec-rlest-apprais-ml-hedpric}
...
#### CMA with Comp Price Adjustments  {#sec-rlest-apprais-ml-cmaprc}

##### Process {#sec-rlest-apprais-ml-cmaprc-proc}
...
##### Misc {#sec-rlest-apprais-ml-cmaprc-misc}
...
##### Market Price {#sec-rlest-apprais-ml-cmaprc-marprc}
...
##### Building-Floor {#sec-rlest-apprais-ml-cmaprc-bldflr}
...
##### Location {#sec-rlest-apprais-ml-cmaprc-loc}
...
-   NLP
    -   Identify the most important words in a description and learn which words tend to be used to describe more expensive or affordable houses.\
        ![](./_resources/Real_Estate.resources/nlp-example.png)
-   Sociodemographic
    -   Misc
