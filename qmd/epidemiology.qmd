...
-   {[bigDM](https://github.com/spatialstatisticsupna/bigDM)}
		...
		-   k-order neighborhood model - Breaks up local spatial or spatio-temporal domains so that estimations can distributed and local area dependencies (neighborhoods) can be accounted for.
