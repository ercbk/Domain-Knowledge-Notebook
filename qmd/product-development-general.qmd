...
-   Packages
    -   [{]{style="color: #990000"}[npdsim](https://cran.r-project.org/web/packages/npdsim/index.html){style="color: #990000"}[}]{style="color: #990000"} - Simulate demand and attributes for ready to launch new products during their life cycle, or during their introduction and growth phases
...
-   PostHog (open-source)
    -   Can be integrated with Airbyte
-   Hotjar
-   [Statsig](https://www.statsig.com/) - An integrated platform for experimentation, analytics, feature flags, session replays, and more
...
-   Cross-Product Adoption Metrics - Which types consumers have purchased multiple products
    ...
    -   Also see
        ...
        -   [Association, General \>\> Discrete](https://ercbk.github.io/Data-Science-Notebook/qmd/association-general.html#sec-assoc-gen-disc){style="color: green"} \>\> Misc \>\> Binary vs Binary Similarity measures
