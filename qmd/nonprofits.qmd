...
-   [Mission and Theory of Change]{.underline}
    ...
    -   Example\
        ![](./_resources/Nonprofits.resources/1-Ap92XjwEYV-kuAou_2nicg.png){width="332"}
...
-   Should be designed to be measurable, clear, and actionable 
    -   Also see nonprofit example in [Data Science Notebook, Projects, Planning \>\> General Steps to Starting a Project](https://ercbk.github.io/Data-Science-Notebook/qmd/project-planning.html#sec-proj-plan-gensteps){style="color: green"}
...
-   Example  
    ![](./_resources/Nonprofits.resources/1-1Zj8iZRg_8ClIH2ocpXZqQ.png){width="632"}
