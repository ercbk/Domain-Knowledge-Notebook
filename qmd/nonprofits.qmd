...
-   Should be designed to be measurable, clear, and actionable (Also see nonprofit example in  [Project Management](Project Management) >> General Steps to Starting a Project)
