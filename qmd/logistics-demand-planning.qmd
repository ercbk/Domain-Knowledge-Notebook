...
- [Misc]{.underline}
  ...
  - Also see [Forecasting, Deep Learning \>\> Misc](https://ercbk.github.io/Data-Science-Notebook/qmd/forecasting-dl.html#sec-fcast-dl-misc){style="color: green"} \>\> Predictive Adjustment
...
- Packages
  - [{]{style="color: #990000"}[fable.intermittent](https://cran.r-project.org/web/packages/fable.intermittent/index.html){style="color: #990000"}[}]{style="color: #990000"} - Extends the [{fable}]{style="color: #990000"} framework to support forecasting methods specifically designed for intermittent time series data, where demand occurs sporadically with many zero values.
- Notes from
