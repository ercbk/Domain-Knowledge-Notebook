...
-   [Example]{.ribbon-highlight}: Extreme hot weather events in Western Europe-Atlantic region
    ...
    -   Model
        ...
        -   Resolution
            -   There's a predictor for each 5.6 x 5.6 degree (lat-lon) grid points![](./_resources/Meteorology.resources/Screenshot-(1399).png){width="432"}
                -   Shows the Western Europe-Atlantic region (disregard the horizontal black line)
            -   There's a response variable for each 1.3 x 0.3 degree (lat-lon) grid points![](./_resources/Meteorology.resources/Screenshot-(1398).png){width="432"}
        ...
        -   Model![](./_resources/Meteorology.resources/Screenshot-(1400).png){width="632"}
